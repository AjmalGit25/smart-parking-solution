...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 bg-slate-800 border-b border-slate-700">
      <Link to="/" className="text-xl font-bold text-indigo-400 no-underline">
        🚗 SmartPark
      </Link>
